...
export default function LoginLoading() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-background" aria-busy="true" aria-label="Loading sign-in page">
      <div className="w-full max-w-sm space-y-8 px-6">
        {/* Heading + subtitle */}
        <div className="flex flex-col items-center gap-2">
          <div className="h-9 w-36 rounded bg-muted motion-safe:animate-pulse" />
