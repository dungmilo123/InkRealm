...
export default function RegisterLoading() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-background" aria-busy="true" aria-label="Loading registration page">
      <div className="w-full max-w-sm space-y-8 px-6">
        {/* Heading + subtitle */}
        <div className="flex flex-col items-center gap-2">
          <div className="h-9 w-44 rounded bg-muted motion-safe:animate-pulse" />
          <div className="h-4 w-64 rounded bg-muted motion-safe:animate-pulse" />
        </div>
